...
bool UnitTest_DzBridgeMorphSelectionDialog::GetMorphRenaming(UnitTest::TestResult* testResult)
{
	bool bResult = true;
	TRY_METHODCALL(qobject_cast<DzBridgeMorphSelectionDialog*>(m_testObject)->GetMorphRenaming());
	return bResult;
}
