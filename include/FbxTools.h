...
public:
	...
	static void RenameDuplicateBones(FbxNode* pRootNode);

	static FbxNode* FindRootBone(FbxNode* pRootNode, FbxScene* pScene);

	static FbxNode* AddRootBone(FbxNode* pRootNode, FbxScene* pScene);
	...
	static FbxNode* ImportNode(QString sSourceNodeName, FbxNode* pDestinationParent, FbxScene* pSourceScene, FbxScene* pDestinationScene, FbxNode* pDestinationRootBone);
